  ...
  async getNonce() {
    try {
      ...
      if (serverGetNonce == 'AwLight' || nonce == '') {        
          ...
          let AwServerMine = 'https://awserver.maesodinfo.repl.co/mine?waxaccount='+wax.userAccount+'&difficulty='+difficulty+'&lastMineTx='+last_mine_tx
          ...
          nonce = mine_work.rand_str
          console.log('AwLight Local Mine : ', nonce)*/
          message = 'AwLight Good Jop M : ' + nonce
